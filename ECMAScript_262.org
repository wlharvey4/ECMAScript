...
Every object has the associated /attributes/:
...
through the specially named =__proto__= property, and you can use this property
to directly query or set the prototype of any object.
